 ...
 * @license MIT
 */
import { g as preloadVite, h as getVite, l as loadConfig, n as watch, t as run$1 } from "../typegen-Kw6yr-oy.js";
...
async function build(root, options = {}) {
	...
	let { build } = await import("../build-CrFDli8U.js");
...
async function dev(root, options = {}) {
	let { dev } = await import("../dev-D35pdIX0.js");
	if (options.profile) await start();
